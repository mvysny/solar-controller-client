...
val dummyRenogyData = RenogyData(
    LocalDateTime(LocalDate(2022, 9, 17), LocalTime(12, 44, 0)),
    dummySystemInfo,
    dummyPowerStatus,
    dummyDailyStats,
    dummyHistoricalData,
